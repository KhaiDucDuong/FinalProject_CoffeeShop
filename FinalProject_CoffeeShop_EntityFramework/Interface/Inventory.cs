...
namespace FinalProject_CoffeeShop.Interface
{
    public partial class Inventory : Form
    {
        ...
        bool add;
        string error = "";
        BL_inventory db = new BL_inventory();
        ...
        private void loadData()
        {
            try
            {
                ...
                dgv_Inventory_CellClick(null, null);
            }
            catch (SqlException)
            {
        ...
        private void btn_Add_Click(object sender, EventArgs e)
        {
            ...
            this.Inventory_txt_CheckId.Focus();
        }
        ...
        private void btn_Edit_Click(object sender, EventArgs e)
        {
            if (dgv_Inventory.RowCount >= 2)
            {
                ...
                this.Inventory_txt_DateCheck.Focus();
            }
        }
        ...
        private void btn_Delete_Click(object sender, EventArgs e)
        {
            if (dgv_Inventory.RowCount >= 2)
            {
                int rowIndex = dgv_Inventory.CurrentCell.RowIndex;

                string selectedItemID = dgv_Inventory.Rows[rowIndex].Cells[0].Value.ToString();
        ...
        private void dgv_Inventory_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (dgv_Inventory.RowCount >= 2)
            {
                ...
                this.Inventory_txt_CheckId.Text = dgv_Inventory.Rows[rowIndex].Cells[0].Value.ToString();
                this.Inventory_txt_DateCheck.Text = dgv_Inventory.Rows[rowIndex].Cells[1].Value.ToString();
                this.Inventory_txt_CheckerId.Text = dgv_Inventory.Rows[rowIndex].Cells[2].Value.ToString();
            }
        }
        ...
        private void addRow()
        {
            ...
            try
            {
                db.addNewRow(this.Inventory_txt_CheckId.Text, this.Inventory_txt_DateCheck.Text, this.Inventory_txt_CheckerId.Text, ref error);
        ...
        private void updateRow()
        {
            ...
            try
            {
                db.updateRow(this.Inventory_txt_CheckId.Text, this.Inventory_txt_DateCheck.Text, this.Inventory_txt_CheckerId.Text, ref error);
                loadData();
                if (!printError())
        ...
        {
            dgv_Inventory.DataSource = db.getData();
            dgv_Inventory.AutoResizeColumns();
        }
        ...
        {
            if (checkSpecialCharactersForString(Inventory_txt_CheckId.Text) ||
                checkSpecialCharactersForString(Inventory_txt_CheckerId.Text)
                )
                return true;
